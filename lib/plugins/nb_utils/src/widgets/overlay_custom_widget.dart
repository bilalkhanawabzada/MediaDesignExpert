...
class OverlayCustomWidget extends StatelessWidget {
  ...
  const OverlayCustomWidget({super.key, 
...
class _OverlayBuilderState extends State<OverlayBuilder> {
  ...
  void initState() {
    ...
    if (widget.showOverlay) {
      makeNullable(WidgetsBinding.instance)!.addPostFrameCallback((_) => showOverlay());
    }
  }
  ...
  void didUpdateWidget(OverlayBuilder oldWidget) {
    ...
    makeNullable(WidgetsBinding.instance)!.addPostFrameCallback((_) => syncWidgetAndOverlay());
  }
...
class OverlayOffsetWidget extends StatelessWidget {
  ...
  const OverlayOffsetWidget({super.key, 
    this.position,
    this.child,
  });
