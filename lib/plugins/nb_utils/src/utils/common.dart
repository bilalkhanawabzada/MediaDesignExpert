...
void toasty(
  ...
  FToast().showToast(
    child: Container(
      ...
      padding: padding ?? const EdgeInsets.symmetric(vertical: 16, horizontal: 30),
  ...
  switch (dialogAnimation) {
    case DialogAnimation.ROTATE:
      return Transform.rotate(
        ...
        child: Opacity(
            opacity: animation.value, child: FadeTransition(opacity: animation, child: child)),
      );
    ...
    case DialogAnimation.SCALE:
      return Transform.scale(
          scale: animation.value, child: FadeTransition(opacity: animation, child: child));
